...
export function validateTest(t,projects){
 ...
 const allowed={file:['path','exists','kind','minBytes','maxBytes','sha256'],text:['path','includes','excludes','minLines','maxLines'],json:['path','checks'],csv:['path','delimiter','columns','minRows','maxRows','unique','rules'],compare:['left','right','mode'],http:['url','method','headers','body','status','includes','checks','maxDurationMs'],command:['executable','args','cwd','expectedExitCodes','includes','excludes','maxDurationMs'],manual:['steps','expected']};keys(c,allowed[t.type],'Konfiguration');
